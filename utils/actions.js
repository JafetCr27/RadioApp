...
export const uploadImage = async (image,path,name) => {
    const result = { statusResponse : true, error : null, url:"" }
...
export const reauthenticate = async (password) =>{
    ...
    const credenciales = firebase.auth.EmailAuthProvider.credential(user.email, password)
    try {
...
export const getPatrocinios = async(limitRestaurants) => {
